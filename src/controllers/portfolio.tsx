    ...
    <Section id="portfolio" title="Portfolio">
      ...
      >
        <Project
          ...
          text="A product needed to be built for panellist users to be able to complete the in-app studies so that we could measure user attention. This product was built in GO a technology I taught myself on the fly. The development team was very small, just me and my team lead, so there was a very high level of responsibility."
